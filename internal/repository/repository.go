...
type TenderRepository interface {
	...
	RollbackTender(ctx context.Context, tenderID string, version int) (*models.TenderResponse, error)
}
...
type BidRepository interface {
	...
	GetBidsForTender(ctx context.Context, tenderID string, username string, limit, offset int) ([]models.Bid, error)
